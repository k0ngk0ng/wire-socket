...
type Route struct {
	...
	Metric        int       `json:"metric,omitempty"`            // Route priority (lower = higher priority)
	Comment       string    `json:"comment"`
	Enabled       bool      `gorm:"default:true" json:"enabled"`
	PushToClient  bool      `gorm:"default:true" json:"push_to_client"`   // Push this route to VPN clients
	ApplyOnServer bool      `gorm:"default:false" json:"apply_on_server"` // Apply this route on server
	CreatedAt     time.Time `json:"created_at"`
	UpdatedAt     time.Time `json:"updated_at"`
}
