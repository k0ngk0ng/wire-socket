...
// User represents a user account (managed by auth service)
type User struct {
...
func (db *DB) InitAdmin(passwordHash string) error {
	var count int64
...
func (db *DB) GetUserAllowedTunnels(userID uint) ([]string, error) {
