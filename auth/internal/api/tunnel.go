...
func NewTunnelHandler(db *database.DB) *TunnelHandler {
...
func (h *TunnelHandler) verifyMasterToken(token string) bool {
	// This should be configured in the auth service config
	// For now, use a placeholder - will be replaced with config
